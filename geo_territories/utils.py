...
from geo_territories.models import Country, Province
from users.constants import DEFAULT_COUNTRY_CODE, DEFAULT_PROVINCE_CODE

logger = logging.getLogger("django")


def create_country(**kwargs: Any) -> Country:
    model_params = {}
...
def create_province(country: Country, **kwargs: Any):
