...
from geo_territories.utils import get_default_country
from users.constants import DEFAULT_COUNTRY_CODE, LANGUAGE_CHOICES
from users.models.base_user import BaseUser
